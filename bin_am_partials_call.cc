...
double S=100,K=90,r=0.09,sigma=0.25,time=0.5,delta=0.0,gamma=0.0,theta=0.0,vega=0.0,rho=0.0;
int no_steps=2;

cout<<"price="<<option_price_partials_american_call_binomial(S,  // spot price
                                                  K,  // Exercise price,
                                                  r,     // interest rate
                                                  sigma, // volatility
                                                  time,  // time to maturity
                                                  no_steps, // steps in binomial
                                                  delta, //  partial wrt S
                                                  gamma, //  second prt wrt S
                                                  theta, // partial wrt time
                                                  vega,  //  partial wrt sigma
                                                  rho)<<endl;   // partial wrt r
}
