/* option price of bermundan binomial call option */
#include<iostream>
#include <cmath> 
#include <vector>   
using namespace std;
...
int main(){
double S=100,K=90,r=0.09,q=0.00,sigma=0.25,time=0.5,potential_exercise_times=0.0;
int steps=2;
cout<<"bermundan_call_option_price="<<option_price_call_bermudan_binomial(S,K,r,q,sigma,time,potential_exercise_times)<<endl;
